...
- Qwen/Qwen2.5-72B-Instruct - Decoder: The model you are currently interacting with, designed for a variety of tasks including text generation and instruction following.
...
- meta-llama/Llama-3.2-11B-Vision-Instruct - Encoder-Decoder: A smaller version of the Llama model from Meta, with capabilities for both text and vision tasks.
